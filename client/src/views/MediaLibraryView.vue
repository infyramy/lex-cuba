  ...
  <AdminLayout>
    <div class="mx-auto max-w-7xl space-y-6">
      <div class="admin-hero">
        <div class="space-y-2">
          <p class="page-kicker">Media Services</p>
          <h1 class="page-title">Media Library</h1>
          <p class="page-subtitle">Upload assets, review file details, and manage reusable media with clearer selection and metadata controls.</p>
        </div>
        <div class="admin-actions">
          <span class="admin-pill bg-slate-100 text-slate-600">{{ rows.length }} asset{{ rows.length === 1 ? "" : "s" }}</span>
        </div>
      </div>
